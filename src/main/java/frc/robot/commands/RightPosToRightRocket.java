...
public class RightPosToRightRocket extends CommandGroup {

  public RightPosToRightRocket() {
    ...
    Trajectory leftTraj2 = Pathfinder.readFromCSV(
      new File("home//lvuser//RightPosGoToRocket.left.pf1.csv"));
    Trajectory rightTraj2 = Pathfinder.readFromCSV(
      new File("home//lvuser//RightPosGoToRocket.right.pf1.csv"));
