...
public class LeftPosToFrontLeftCargoShip extends CommandGroup {

  public LeftPosToFrontLeftCargoShip() {
    ...
    Trajectory leftTraj2 = Pathfinder.readFromCSV(
      new File("home//lvuser//LeftPosGoToCargoShip.left.pf1.csv"));
    Trajectory rightTraj2 = Pathfinder.readFromCSV(
      new File("home//lvuser//LeftPosGoToCargoShip.right.pf1.csv"));
